...
import de.fzi.dbs.verification.addon.datatype.atomic.AnyURITypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.BooleanTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.EntityTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.ErrorTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.QnameTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.SimpleURTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.binary.Base64BinaryTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.binary.HexBinaryTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.datetime.DateTimeTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.datetime.DateTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.datetime.DurationTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.datetime.GDayTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.datetime.GMonthDayTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.datetime.GMonthTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.datetime.GYearMonthTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.datetime.GYearTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.datetime.TimeTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.ByteTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.DoubleTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.FloatTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.IntTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.IntegerTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.LongTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.NegativeIntegerTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.NonNegativeIntegerTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.NonPositiveIntegerTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.NumberTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.PositiveIntegerTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.UnsignedByteTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.UnsignedIntTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.UnsignedLongTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.number.UnsignedShortTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.string.IDREFTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.string.IDTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.string.LanguageTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.string.NameTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.string.NcnameTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.string.NmtokenTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.string.NormalizedStringTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.string.StringTypeVC;
import de.fzi.dbs.verification.addon.datatype.atomic.string.TokenTypeVC;
import de.fzi.dbs.verification.addon.datatype.facet.lexical.FractionDigitsFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.lexical.PatternFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.lexical.TotalDigitsFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.lexical.WhiteSpaceFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.value.EnumerationFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.value.LengthFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.value.MaxExclusiveFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.value.MaxInclusiveFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.value.MaxLengthFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.value.MinExclusiveFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.value.MinInclusiveFacetVC;
import de.fzi.dbs.verification.addon.datatype.facet.value.MinLengthFacetVC;
...
public class VerificatorConstructorFactory
{
  ...
  static
  {
    ...
    vcs.put(ShortType.class, de.fzi.dbs.verification.addon.datatype.atomic.number.ShortTypeVC.class);
